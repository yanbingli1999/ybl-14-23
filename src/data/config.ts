...
export const GAME_CONFIG = {
  ...
  LOAD_PER_MATCH: 1,
  BATCH_CONTRACT_CHANCE: 0.35,
  BATCH_MIN_COUNT: 2,
  BATCH_MAX_COUNT: 3,
  BATCH_LOCK_REWARD_RATE: 0.6,
  BATCH_RECLAIM_RATE: 0.8,
  BATCH_REPUTATION_PER_SUCCESS: 15,
  BATCH_REPUTATION_PER_FAIL: -10,
  BATCH_COMPLETION_BONUS_RATE: 0.3,
};
